        ...
        <div class="max-w-6xl mx-auto px-6">
          ...
          <div class="glass-card rounded-3xl overflow-hidden glow-shadow">
            <div class="relative h-96">
              <img src="https://m.media-amazon.com/images/I/61SHgmLiP0L._AC_SX425_.jpg" alt="Calculator Application" 
                   (click)="window.open('https://m.media-amazon.com/images/I/61SHgmLiP0L._AC_SX425_.jpg', '_blank')"
                   class="w-full h-full object-cover cursor-pointer">
              <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
              <div class="absolute bottom-8 left-8">
                <h1 class="text-5xl font-black gradient-text mb-4">Basic Calculator</h1>
                <p class="text-xl text-gray-300">Desktop Calculator Application</p>
              </div>
            </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                  <div>
                    ...
                    <p class="text-gray-300 leading-relaxed text-lg">
                      A functional desktop calculator application built with JavaFX. 
                      Supports basic mathematical operations including addition, subtraction, multiplication, and division.
                    </p>
                  </div>
                </div>
