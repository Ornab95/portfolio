        ...
        <div class="max-w-6xl mx-auto px-6">
          ...
          <div class="glass-card rounded-3xl overflow-hidden glow-shadow">
            <div class="relative h-96">
              <img src="assets/TMS/Home.png" alt="Task Management System" 
                   (click)="window.open('assets/TMS/Home.png', '_blank')"
                   class="w-full h-full object-cover cursor-pointer">
              <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
              <div class="absolute bottom-8 left-8">
                <h1 class="text-5xl font-black gradient-text mb-4">Daily Task Management</h1>
                <p class="text-xl text-gray-300">Productivity & Organization Tool</p>
              </div>
            </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                  <div>
                    ...
                    <p class="text-gray-300 leading-relaxed text-lg">
                      A comprehensive task management application designed to help users stay organized and productive. 
                      Features include task creation, priority management, deadline tracking, and progress monitoring.
                    </p>
                  </div>
...
export class TaskManagementComponent {
  ...
  protected readonly screenshots = [
    { image: 'assets/TMS/Home.png', title: 'Dashboard', description: 'Main task management dashboard' },
    { image: 'assets/TMS/Login.png', title: 'Login Page', description: 'User authentication interface' },
    { image: 'assets/TMS/Registration.png', title: 'Registration', description: 'User registration form' }
  ];
}