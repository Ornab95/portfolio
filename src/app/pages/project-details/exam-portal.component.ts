        ...
        <div class="max-w-6xl mx-auto px-6">
          ...
          <div class="glass-card rounded-3xl overflow-hidden glow-shadow">
            <div class="relative h-96">
              <img src="assets/Photo/PostmanQuiz APIs.png" alt="Exam Portal API" 
                   (click)="window.open('assets/Photo/PostmanQuiz APIs.png', '_blank')"
                   class="w-full h-full object-cover cursor-pointer">
              <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
              <div class="absolute bottom-8 left-8">
                <h1 class="text-5xl font-black gradient-text mb-4">Exam Portal API</h1>
                <p class="text-xl text-gray-300">RESTful Quiz Management System</p>
              </div>
            </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                  <div>
                    ...
                    <p class="text-gray-300 leading-relaxed text-lg">
                      A comprehensive RESTful API for managing online quizzes and evaluations. 
                      Built with Spring Boot and JPA, featuring automated grading and result management.
                    </p>
                  </div>
                </div>
...
export class ExamPortalComponent {
  ...
  protected readonly technologies = [
    ...
    { name: 'JPA', icon: 'fas fa-database text-blue-600' },
