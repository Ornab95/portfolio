        ...
        <div class="max-w-6xl mx-auto px-6">
          ...
          <div class="glass-card rounded-3xl overflow-hidden glow-shadow">
            <div class="relative h-96">
              <img src="assets/obsms/Sales.png" alt="Store Management System" 
                   (click)="window.open('assets/obsms/Sales.png', '_blank')"
                   class="w-full h-full object-cover cursor-pointer">
              <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
              <div class="absolute bottom-8 left-8">
                <h1 class="text-5xl font-black gradient-text mb-4">Store Management System</h1>
                <p class="text-xl text-gray-300">Online Store Management</p>
              </div>
            </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                  <div>
                    ...
                    <p class="text-gray-300 leading-relaxed text-lg">
                      A comprehensive online store management system for inventory tracking, sales management, 
                      and customer relationship management. Built with PHP and MySQL for robust data handling.
                    </p>
                  </div>
...
export class StoreManagementComponent {
  ...
  protected readonly screenshots = [
    { image: 'assets/obsms/Sales.png', title: 'Sales Dashboard', description: 'Sales tracking and analytics' }
  ];
}